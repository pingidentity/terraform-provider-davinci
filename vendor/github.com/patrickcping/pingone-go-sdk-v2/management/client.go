...
// APIClient manages communication with the PingOne Platform API - SSO and Base API v2022-08-02
...
type APIClient struct {
	...
	AuthenticationsPerApplicationApi *AuthenticationsPerApplicationApiService
