...
func (r ApiCreateImageRequest) File(file *[]byte) ApiCreateImageRequest {
	r.file = &file
	return r
}
...
*/
func (a *ImagesApiService) CreateImage(ctx context.Context, environmentID string) ApiCreateImageRequest {
	return ApiCreateImageRequest{
		ApiService:    a,
		ctx:           ctx,
...
*/
func (a *ImagesApiService) DeleteImage(ctx context.Context, environmentID string, imgID string) ApiDeleteImageRequest {
	return ApiDeleteImageRequest{
		ApiService:    a,
		ctx:           ctx,
		environmentID: environmentID,
...
*/
func (a *ImagesApiService) ReadImage(ctx context.Context, environmentID string, imgID string) ApiReadImageRequest {
	return ApiReadImageRequest{
		ApiService:    a,
		ctx:           ctx,
		environmentID: environmentID,
...
func (a *ImagesApiService) ReadImageExecute(r ApiReadImageRequest) (*Image, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ImagesApiService.ReadImage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
