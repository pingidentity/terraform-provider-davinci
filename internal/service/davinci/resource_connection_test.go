...
func TestAccResourceConnection_Slim(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccResourceConnection_Slim_Hcl(resourceName, "slim", true),
				Check:  testCheck,
			},
			{
				Config:  testAccResourceConnection_Slim_Hcl(resourceName, "slim", true),
			...
			{
				Config: testAccResourceConnection_Slim_Hcl(resourceName, "slim", false),
				Check:  testCheck,
			},
...
func TestAccResourceConnection_SlimWithUpdate(t *testing.T) {
	...
	beforeHcl := testAccResourceConnection_Slim_Hcl(resourceName, "before", true)
	afterHcl := testAccResourceConnection_Slim_Hcl(resourceName, "after", true)
...
func testAccResourceConnection_Slim_Hcl(resourceName, valuePrefix string, minimalDaVinci bool) (hcl string) {
	baseHcl := acctest.PingoneEnvironmentSsoHcl(resourceName, minimalDaVinci)
...
func TestAccResourceConnection_RemovalDrift(t *testing.T) {
	...
	hcl := testAccResourceConnection_Slim_Hcl(resourceName, "slim", true)
